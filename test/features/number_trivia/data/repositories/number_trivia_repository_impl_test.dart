...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      test('should return remote data when the call to remote ds', () async {
        // arrange
      ...
      test('should cache data locally when the call to remote ds', () async {
        // arrange
        when(mockRemoteDataSource.getConcreteNumberTrivia(any))
            .thenAnswer((_) async => tNumberTriviaModel);
      ...
      test('should return server failure when remote call is failed', () async {
        // arrange
        when(mockRemoteDataSource.getConcreteNumberTrivia(any))
    ...
    runTestsOffline(() {
      test('should return last locally cached data when exists', () async {
        // arrange
      ...
      test('should return cache failure when no last data', () async {
        // arrange
        when(mockLocalDataSource.getLastNumberTrivia())
